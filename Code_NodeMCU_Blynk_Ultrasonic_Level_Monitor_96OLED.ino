#define BLYNK_TEMPLATE_ID "TMPL37XVRzBPO"
#define BLYNK_TEMPLATE_NAME "Water Saver System"
#define BLYNK_AUTH_TOKEN "wBGfGk1A8biLrzlnOuVxtkeb3uguhfEJ"
